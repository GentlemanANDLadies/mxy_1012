...
var ImgArr=["../images/1.png","../images/2.png","../images/3.png","../images/4.png","../images/5.png","../images/6.png"];

var music=document.querySelector("audio");
music.pause();
function Ship(ctx){
	gameMonitor.im.loadImage(['../images/player.png']);//聚财宝图片
	this.width = 100;
	this.height = 150;
	this.left = gameMonitor.w/2 - this.width/2;
	this.top = gameMonitor.h - 2*this.height;
	this.player = gameMonitor.im.createImage('../images/player.png');//聚财宝图片
